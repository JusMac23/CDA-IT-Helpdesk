            ...
            <form id="editForm" method="POST" action="#">
                ...
                <div class="form-grid">
                    <div class="form-group col-span-2">
                        ...
                        <input type="text" name="firstname" id="edit_firstname" class="form-input">
                    </div>
                    ...
                    <div class="form-group col-span-2">
                        ...
                        <input type="text" name="lastname" id="edit_lastname" class="form-input">
                    </div>

                    <div class="form-group col-span-2">
                        <label for="edit_it_email" class="form-label">Email</label>
                        <input type="email" name="it_email" id="edit_it_email" class="form-input">
                    </div>

                    <div class="form-group col-span-2">
                        <label for="edit_it_area" class="form-label">IT Area</label>
                        <select name="it_area" id="edit_it_area" class="form-select">
