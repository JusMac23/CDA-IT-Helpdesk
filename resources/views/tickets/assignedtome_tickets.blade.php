            ...
            <div class="w-full">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8">
                    <div class="p-2 text-gray-900">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-4">Tickets Assigned to Me</h3>
                        ...
                        <div class="flex justify-end pt-6 mb-4">
                            <form action="{{ route('assignedtome_tickets.index') }}" 
                                method="GET" 
